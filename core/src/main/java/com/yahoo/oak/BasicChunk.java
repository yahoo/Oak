...
abstract class BasicChunk<K, V> {
    ...
    protected static final int INVALID_ENTRY_INDEX = -1;
    ...
    protected final EntryArray array;
    ...
    /* ########################################################################################
       # Methods for managing the read, allocation and release paths of keys and values of a
       # specific entry
       ######################################################################################## */
    ...
    /**
     * Completes the deletion of a mapping
