...
public interface OakMapOld<K, V> {
     ...
     */
    OakMapOld subMap(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive);
     ...
     *                                  bounds of the range
     */
    OakMapOld headMap(K toKey, boolean inclusive);
     ...
     *                                  bounds of the range
     */
    OakMapOld tailMap(K fromKey, boolean inclusive);
