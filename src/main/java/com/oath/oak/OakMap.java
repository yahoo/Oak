...
public class OakMap<K, V> implements AutoCloseable {
    ...
    OakMap(K minKey, OakSerializer<K> keySerializer, OakSerializer<V> valueSerializer, OakComparator<K> oakComparator,
        ...
        this.keyDeserializeTransformer = byteBuffer -> keySerializer.deserialize(byteBuffer);
        this.valueDeserializeTransformer = byteBuffer -> valueSerializer.deserialize(byteBuffer);
